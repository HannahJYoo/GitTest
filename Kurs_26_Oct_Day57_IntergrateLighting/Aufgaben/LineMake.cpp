...
void LineMake::MeshData(vector<VertexColor> vertices, vector<UINT> indices, UINT objNum)
{
	ClearBuffer();
...
void LineMake::DrawBox(const D3DXVECTOR3 & minPos, const D3DXVECTOR3 & maxPos)
{
	ClearBuffer();
