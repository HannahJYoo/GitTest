...
MeshCube::MeshCube()
	: GameModel(Materials + L"Bevor/", L"Cube.material", Models + L"Bevor/", L"Cube.mesh")
{
...
void MeshCube::GetAABB(std::vector<D3DXVECTOR3>& aabbBox)
{
